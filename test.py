...
def create_test_sets(length, start=0):
    try:
        ...
        # add a logging statement to confirm that the function ran successfully
        print("create_test_sets() completed successfully")
    except Exception as e:
        # print any errors that occurred
        print(f"An error occurred in create_test_sets(): {e}")
