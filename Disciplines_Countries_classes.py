...
class CountriesProcessor(ResultsProcessor):
    def __init__(self, meta_coverage, meta_coverage_processed_files="/home/runner/work/test-play/test-play/OCMeta_DOAJ_ErihPlus_merged.csv"): 
...
class CountsProcessor(ResultsProcessor):
    ...
    def __init__(self, meta_df, export_path, meta_coverage_processed_files="/home/runner/work/test-play/test-play/OCMeta_DOAJ_ErihPlus_merged.csv"):
